# Exercício 3 – Mudança acentuada de direção
# • Pontos: A(0,0), B(4,8), C(1,10)
#   - Determine os vetores AB e BC.
#   - Calcule as distâncias e o ângulo.
#   - Interprete o resultado (mudança acentuada).
